...
folder_path = "aiforevil/GEO_TIFF Files"
filename = "s2_sr_median.tif"  # The name you want to give to the uploaded image


credentials = service_account.Credentials.from_service_account_file(SERVICE_ACCOUNT_FILE)
client = storage.Client(credentials=credentials, project="spatial-design-studio-401610")


bucket = client.get_bucket(bucket_name)
blob = bucket.blob(f"{folder_path}/{filename}")
blob.upload_from_filename(s2_sr_median.getDownloadURL({'name': filename}))