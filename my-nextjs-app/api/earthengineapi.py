...
class GoogleApi:
    def __init__(self, START_DATE='2020-06-01', END_DATE='2020-09-01', AOI=None):
        ...
        self.s2_sr_median = (self.s2_sr_cld_col.map(self.add_cld_shdw_mask)
