...
export const FFDate: React.FC = () => {
  ...
  const htmlContent = `
    <div>
      ...
      <Image style="display: block; margin-left: auto;margin-right: auto; width: 70%; alignment:center; margin-top: 1.5rem" src="${cropData}" alt="Cropped image" width={500} height={500} justify: center></Image>
    </div>`;
